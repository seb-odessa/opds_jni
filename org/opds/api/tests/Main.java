...
public class Main {
    ...
    // left: '[Игра королев. Женщины, которые изменили историю Европы - Сара
    // Гриствуд (2024-06-07) [2,67 MB], Рыцари, закованные в сталь - Говард Пайл
    // (2024-06-01) [2,46 MB]]'
    // right: '[Игра королев. Женщины, которые изменили историю Европы - Сара
    // Гриствуд (2024-06-07) [2.67 MB], Рыцари, закованные в сталь - Говард Пайл
    // (2024-06-01) [2.46 MB]]'
